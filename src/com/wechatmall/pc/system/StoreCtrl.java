...
public class StoreCtrl extends BaseCtrl {
    ...
    public void listStore(){
        ...
        String select = "select sid id,sname storeName,scity cityName,sadmin managerName,saddress address,sphone managerPhone,(select dname from w_dictionary where sstatus = dvalue and dparent_id = 300) 'status',stime workTime   ";
    ...
    public void showStoreById(){
        ...
        String sql = "select sid id,sname storeName,scity cityName,sadmin managerName,saddress address,sphone phone,slongitude longitude,slatitude latitude from w_store where id = ? ";
        try{
            /**
             * 根据id查询物流分类
             */
